...
class Temperature:
    """
    Represent a temperature value extract from the timeanddate.com/weather webpage.
    """
    headers = {
        'pragma': 'no-cache',
    ...
    def get(self):
        ...
        #print(scraped_content['temp'])
        return float(scraped_content['temp'].replace("°C", "").strip())


if __name__=="__main__":
    temperature = Temperature(country="romania", city="bucharest")
